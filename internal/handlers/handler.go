...
import (
	...
	"github.com/franciscogonz64/bookings/internal/driver"
	"github.com/franciscogonz64/bookings/internal/forms"
	"github.com/franciscogonz64/bookings/internal/helpers"
	...
	"github.com/franciscogonz64/bookings/internal/repository/dbrepo"
)
...
func (m *Repository) Woods(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "woods.courtyard.page.tmpl", &models.TemplateData{})
}

// Signature renders the rooms page
func (m *Repository) Signature(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "signature.suite.page.tmpl", &models.TemplateData{})
}
